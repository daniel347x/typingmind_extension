  ...
  function renderPayloadCaptureModal() {
    ...
    items.forEach((cap, idx) => {
      ...
      html += '<div style="font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:flex;align-items:flex-start;gap:0;min-height:18px;">' +
              ...
              '</span>' +
              (model ? (' <span style="font-weight:bold;color:' + modelColor + ';font-size:13px;line-height:1.1;position:relative;top:15px;display:inline-block;">' + model + '</span>') : '') +
              '</div>';
